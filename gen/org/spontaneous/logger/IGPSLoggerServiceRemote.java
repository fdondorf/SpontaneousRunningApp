...
public static abstract class Stub extends android.os.Binder implements org.spontaneous.logger.IGPSLoggerServiceRemote
{
private static final java.lang.String DESCRIPTOR = "org.spontaneous.logger.IGPSLoggerServiceRemote";
...
/**
 * Cast an IBinder object into an org.spontaneous.logger.IGPSLoggerServiceRemote interface,
 * generating a proxy if needed.
 */
public static org.spontaneous.logger.IGPSLoggerServiceRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.spontaneous.logger.IGPSLoggerServiceRemote))) {
return ((org.spontaneous.logger.IGPSLoggerServiceRemote)iin);
}
return new org.spontaneous.logger.IGPSLoggerServiceRemote.Stub.Proxy(obj);
}
...
private static class Proxy implements org.spontaneous.logger.IGPSLoggerServiceRemote
{
